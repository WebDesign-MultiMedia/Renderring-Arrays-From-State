...
export default function App(){
  ...
  return(
    <>
   <div id='body' className="text-center bg-sky-100 h-screen p-8">
      <h1 className="text-3xl font-bold text-orange-600 mb-4">Learners Data</h1>
        ...
        learnerData.map((learner, index) =>(
          <div key={index} className="border-2 border-gray-400  w-1/2 m-auto p-5 bg-white">
            ...
            <button id='btndel' className="bg-blue-500 hover:bg-blue-600 p-2 rounded-lg text-white border-2 border-slate-100" onClick={() =>{
